...
router.get('/portal/facturas/:id',        verifyEmpresa, ctrl.misFacturasDetalle);

// ── Área de empleados ──────────────────────────────────────────────────────────
router.use(verifyToken);

router.get('/dashboard',                              checkPermission('patronales', 'READ'),   ctrl.dashboard);
router.get('/preview',                                checkPermission('patronales', 'READ'),   ctrl.preview);
router.post('/causar',                                lockdownFinanciero, checkPermission('patronales', 'WRITE'),  ctrl.causar);
...
router.post('/facturas/:id/pago',                     lockdownFinanciero, checkPermission('patronales', 'WRITE'),  ctrl.registrarPago);
...
router.post('/empresas/:codigo/causar',               lockdownFinanciero, checkPermission('patronales', 'WRITE'),  ctrl.causarEmpresa);

router.get('/asociados/:codigo/aporte',               checkPermission('patronales', 'READ'),   ctrl.historialAporte);
router.put('/asociados/:codigo/aporte',               lockdownFinanciero, checkPermission('patronales', 'WRITE'),  ctrl.actualizarAporte);
