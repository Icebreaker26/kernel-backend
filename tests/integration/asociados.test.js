...
describe('Asociados — reconciliación línea 15 (bonos)', () => {
  ...
  const buildCSV = () => [
    ...
    `15,${COD_OK},Activo,Ok,1,EMP_REC,Empresa Recon,Bogota,Calle A,3010000001,3.000,1`,  // mensual correcto
    `15,${COD_RET},Retirado,Test,1,EMP_REC,Empresa Recon,Bogota,Calle B,3010000002,3.000,1`, // retirado
    `15,${COD_SB},SinBoleto,Test,1,EMP_REC,Empresa Recon,Bogota,Calle C,3010000003,3.000,1`, // sin boleto
    `15,${COD_MAL},MontoMal,Test,1,EMP_REC,Empresa Recon,Bogota,Calle D,3010000004,2.000,1`, // monto mal
